...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Proposition spontanée pour Les Résidences BYOMA (résidences meublées à Cocody) : site de réservation avec disponibilité en temps réel par studio, barre de réservation façon hôtel (dates, voyageurs, résidence) qui mène à la fiche avec calendrier pré-rempli, moteur anti-chevauchement et back-office admin (validation, blocage de périodes). Stack temps réel Convex, design clair et chaleureux à accent ocre, hero photo plein écran sur mobile.",
    tech: ['TanStack Start', 'React 19', 'Convex', 'Better Auth', 'Tailwind v4', 'Vite 7', 'GSAP', 'Radix UI', 'Vercel'],
